...
public class ArmHomePosCommand extends CommandBase {
  ...
  @Override
  public void execute() {
    m_verticalExtension.setArmGoalCommand(m_verticalExtension.calculateVerticalExtensionGoal(Config.kArmHomePosX, Config.kArmHomePosY));
    m_horizontalExtension.setArmGoalCommand(m_horizontalExtension.calculateHorizontalExtensionGoal(Config.kArmHomePosX, Config.kArmHomePosY));
