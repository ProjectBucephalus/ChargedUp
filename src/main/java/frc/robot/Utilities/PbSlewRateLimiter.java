...
public class PbSlewRateLimiter {
 
  // The direction of the profile, either 1 for forwards or -1 for s
   ...
   */
public PbSlewRateLimiter(Constraints constraints, State goal, State initial) {
   ...
   * @param goal The desired state when the profile is complete.
   */
  public PbSlewRateLimiter(Constraints constraints, State goal) {
